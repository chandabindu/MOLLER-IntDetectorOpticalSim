#ifndef MOLLEROptDetectorQuartz5_h
#define MOLLEROptDetectorQuartz5_h 
...
class MOLLEROptDetectorQuartz5 
{
public:
  MOLLEROptDetectorQuartz5(MOLLEROptTrackingReadout*, G4String type5, MOLLEROptMaterial* mat);
  ~MOLLEROptDetectorQuartz5();
...
private:
  ...
  G4SDManager* SDman;
  G4VSensitiveDetector* QuartzSD5;
