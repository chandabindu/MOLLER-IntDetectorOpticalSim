#ifndef MOLLEROptDetectorQuartz3_h
#define MOLLEROptDetectorQuartz3_h 
...
class MOLLEROptDetectorQuartz3 
{
public:
  MOLLEROptDetectorQuartz3(MOLLEROptTrackingReadout*, G4String type3, MOLLEROptMaterial* mat);
  ~MOLLEROptDetectorQuartz3();
...
private:
  ...
  G4SDManager* SDman;
  G4VSensitiveDetector* QuartzSD3;
