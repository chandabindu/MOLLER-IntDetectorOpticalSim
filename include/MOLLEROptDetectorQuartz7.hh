#ifndef MOLLEROptDetectorQuartz7_h
#define MOLLEROptDetectorQuartz7_h 
...
class MOLLEROptDetectorQuartz7 
{
public:
  MOLLEROptDetectorQuartz7(MOLLEROptTrackingReadout*, G4String type7, MOLLEROptMaterial* mat);
  ~MOLLEROptDetectorQuartz7();
...
private:
  ...
  G4SDManager* SDman;
  G4VSensitiveDetector* QuartzSD7;
