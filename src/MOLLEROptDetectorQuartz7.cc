...
MOLLEROptDetectorQuartz7::MOLLEROptDetectorQuartz7(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorQuartz7::~MOLLEROptDetectorQuartz7()
{
  
}


void MOLLEROptDetectorQuartz7::Initialize()
{
  ...
  QuartzSD7 = new MOLLEROptQuartzSD("/Quartz7",TrackingReadout);
  SDman->AddNewDetector(QuartzSD7);  
  QuartzLogical->SetSensitiveDetector(QuartzSD7);
...
void MOLLEROptDetectorQuartz7::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorQuartz7::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorQuartz7::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorQuartz7::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorQuartz7::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorQuartz7::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorQuartz7::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(QuartzSD7) delete QuartzSD7;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorQuartz7::UpdateGeometry()
{
...
void MOLLEROptDetectorQuartz7::GetQuartzLimits(G4double *vals)
{
