...
MOLLEROptDetectorQuartz4::MOLLEROptDetectorQuartz4(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorQuartz4::~MOLLEROptDetectorQuartz4()
{
  
}


void MOLLEROptDetectorQuartz4::Initialize()
{
  ...
  QuartzSD4 = new MOLLEROptQuartzSD("/Quartz4",TrackingReadout);
  SDman->AddNewDetector(QuartzSD4);  
  QuartzLogical->SetSensitiveDetector(QuartzSD4);
...
void MOLLEROptDetectorQuartz4::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorQuartz4::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorQuartz4::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorQuartz4::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorQuartz4::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorQuartz4::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorQuartz4::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(QuartzSD4) delete QuartzSD4;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorQuartz4::UpdateGeometry()
{
...
void MOLLEROptDetectorQuartz4::GetQuartzLimits(G4double *vals)
{
