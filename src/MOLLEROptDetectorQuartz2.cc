...
MOLLEROptDetectorQuartz2::MOLLEROptDetectorQuartz2(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorQuartz2::~MOLLEROptDetectorQuartz2()
{
  
}


void MOLLEROptDetectorQuartz2::Initialize()
{
  ...
  QuartzSD2 = new MOLLEROptQuartzSD("/Quartz2",TrackingReadout);
  SDman->AddNewDetector(QuartzSD2);  
  QuartzLogical->SetSensitiveDetector(QuartzSD2);
...
void MOLLEROptDetectorQuartz2::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorQuartz2::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorQuartz2::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorQuartz2::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorQuartz2::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorQuartz2::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorQuartz2::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(QuartzSD2) delete QuartzSD2;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorQuartz2::UpdateGeometry()
{
...
void MOLLEROptDetectorQuartz2::GetQuartzLimits(G4double *vals)
{
