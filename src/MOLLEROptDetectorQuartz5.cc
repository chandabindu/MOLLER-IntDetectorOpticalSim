...
MOLLEROptDetectorQuartz5::MOLLEROptDetectorQuartz5(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorQuartz5::~MOLLEROptDetectorQuartz5()
{
  
}


void MOLLEROptDetectorQuartz5::Initialize()
{
  ...
  QuartzSD5 = new MOLLEROptQuartzSD("/Quartz5",TrackingReadout);
  SDman->AddNewDetector(QuartzSD5);  
  QuartzLogical->SetSensitiveDetector(QuartzSD5);
...
void MOLLEROptDetectorQuartz5::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorQuartz5::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorQuartz5::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorQuartz5::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorQuartz5::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorQuartz5::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorQuartz5::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(QuartzSD5) delete QuartzSD5;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorQuartz5::UpdateGeometry()
{
...
void MOLLEROptDetectorQuartz5::GetQuartzLimits(G4double *vals)
{
