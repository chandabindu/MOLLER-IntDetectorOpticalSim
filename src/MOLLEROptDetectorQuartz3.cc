...
MOLLEROptDetectorQuartz3::MOLLEROptDetectorQuartz3(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorQuartz3::~MOLLEROptDetectorQuartz3()
{
  
}


void MOLLEROptDetectorQuartz3::Initialize()
{
  ...
  QuartzSD3 = new MOLLEROptQuartzSD("/Quartz3",TrackingReadout);
  SDman->AddNewDetector(QuartzSD3);  
  QuartzLogical->SetSensitiveDetector(QuartzSD3);
...
void MOLLEROptDetectorQuartz3::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorQuartz3::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorQuartz3::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorQuartz3::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorQuartz3::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorQuartz3::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorQuartz3::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(QuartzSD3) delete QuartzSD3;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorQuartz3::UpdateGeometry()
{
...
void MOLLEROptDetectorQuartz3::GetQuartzLimits(G4double *vals)
{
