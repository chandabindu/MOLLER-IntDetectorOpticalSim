...
MOLLEROptDetectorQuartz6::MOLLEROptDetectorQuartz6(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorQuartz6::~MOLLEROptDetectorQuartz6()
{
  
}


void MOLLEROptDetectorQuartz6::Initialize()
{
  ...
  QuartzSD6 = new MOLLEROptQuartzSD("/Quartz6",TrackingReadout);
  SDman->AddNewDetector(QuartzSD6);  
  QuartzLogical->SetSensitiveDetector(QuartzSD6);
...
void MOLLEROptDetectorQuartz6::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorQuartz6::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorQuartz6::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorQuartz6::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorQuartz6::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorQuartz6::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorQuartz6::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(QuartzSD6) delete QuartzSD6;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorQuartz6::UpdateGeometry()
{
...
void MOLLEROptDetectorQuartz6::GetQuartzLimits(G4double *vals)
{
