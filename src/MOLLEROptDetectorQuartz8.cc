...
MOLLEROptDetectorQuartz8::MOLLEROptDetectorQuartz8(MOLLEROptTrackingReadout *TrRO, G4String name, MOLLEROptMaterial* mat)
{
  Name = name+"_Quartz";
...
MOLLEROptDetectorQuartz8::~MOLLEROptDetectorQuartz8()
{
  
}


void MOLLEROptDetectorQuartz8::Initialize()
{
  ...
  QuartzSD8 = new MOLLEROptQuartzSD("/Quartz8",TrackingReadout);
  SDman->AddNewDetector(QuartzSD8);  
  QuartzLogical->SetSensitiveDetector(QuartzSD8);
...
void MOLLEROptDetectorQuartz8::Construct(G4VPhysicalVolume* Mother)
{
...
void MOLLEROptDetectorQuartz8::SetMaterial(G4String materialName)
{

}


void MOLLEROptDetectorQuartz8::SetQuartzRotX(G4double rot)
{
...
void MOLLEROptDetectorQuartz8::SetCenterPositionInX(G4double xPos)
{
    PositionX =xPos;	 
...
void MOLLEROptDetectorQuartz8::SetCenterPositionInY(G4double yPos)
{
    PositionY = yPos;
...
void MOLLEROptDetectorQuartz8::SetCenterPositionInZ(G4double zPos)
{
    PositionZ = zPos;
...
void MOLLEROptDetectorQuartz8::ClearVolumes()
{
  //SDman->Activate("/Detector",false);
  if(QuartzSD8) delete QuartzSD8;
  if(QuartzPhysical) delete QuartzPhysical;
  if(QuartzLogical) delete QuartzLogical;
}


void MOLLEROptDetectorQuartz8::UpdateGeometry()
{
...
void MOLLEROptDetectorQuartz8::GetQuartzLimits(G4double *vals)
{
